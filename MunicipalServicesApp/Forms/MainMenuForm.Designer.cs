namespace MunicipalServicesApp.Forms
{
	partial class MainMenuForm
	{
		...
		private void InitializeComponent()
		{
			...
			// picBanner
			//
			this.picBanner.BackColor = System.Drawing.Color.FromArgb(0, 82, 120);
			...
			// btnReportIssues
			//
			this.btnReportIssues.BackColor = System.Drawing.Color.FromArgb(0, 82, 120);
			...
			// btnLocalEvents
			//
			this.btnLocalEvents.BackColor = System.Drawing.Color.FromArgb(0, 82, 120);
			...
			this.lblFooter.Text = "Service Request Status will be enabled in the final release.";
			//
			// MainMenuForm
			//
